...
# Google Drive Target Folder IDs (For 2. 중국어 암기)
FOLDER_IDS = {
    "01_Database": "1ZfbvibuLW89WSmYm95FAbZqDYALKgpzY",
    "02_Daily_Sheets": "1wXw-BPlB6SezA-pfZNr0drOtqPoZnlzP",
    "03_Print_PDF": "1Np6wJfW6AiPrSZsEFtp3W2ACvZAQoDbc"
}
...
def sync_data_to_gdrive():
    ...
    files_to_sync = [
        ...
        (
            os.path.join("data", "01_Database", "chinese_expressions_db.xlsx"),
            "01_Database",
        ...
        (
            os.path.join("data", "03_Print_PDF", f"Study_Note_{date_str}.md"),
            "03_Print_PDF",
            "text/markdown"
        )
    ]
